...
import ArrowBackModule from "@mui/icons-material/ArrowBack";
...
import PauseModule from "@mui/icons-material/Pause";
...
import RedoModule from "@mui/icons-material/Redo";
...
import StopModule from "@mui/icons-material/Stop";
...
import UndoModule from "@mui/icons-material/Undo";
...
export const AddIcon = icon(AddModule);
export const ArrowBackIcon = icon(ArrowBackModule);
...
export const ContentCopyIcon = icon(ContentCopyModule);
export const ContentPasteIcon = icon(ContentPasteModule);
...
export const PauseIcon = icon(PauseModule);
export const PlayArrowIcon = icon(PlayArrowModule);
export const RadioButtonUncheckedIcon = icon(RadioButtonUncheckedModule);
export const RemoveIcon = icon(RemoveModule);
export const RefreshIcon = icon(RefreshModule);
export const RedoIcon = icon(RedoModule);
...
export const StopIcon = icon(StopModule);
...
export const UndoIcon = icon(UndoModule);
